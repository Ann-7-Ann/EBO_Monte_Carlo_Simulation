...
# Rendering thousands of rays each frame can freeze the UI. This cap only
# affects drawing (physics/detectors still trace all rays up to MAX_RAYS_DEFAULT).
DRAW_RAYS_CAP_DEFAULT = 400
